...
export const gpuData: GPU[] = [
  ...
  { id: 'vast-rtx4090-1', model: 'NVIDIA RTX 4090', provider: 'Vast.ai', price: 0.20, vram: 24, type: 'Mid-Range', providerType: 'Marketplace', gpuCount: 1, systemSpecs: { vCPU: 32, ram: 126 }, availability: 'Available', launchUrl: 'https://cloud.vast.ai/?ref_id=258548', slug: 'rtx4090', lastUpdated: new Date() },
  ...
  { id: 'vast-rtx5090-1', model: 'NVIDIA RTX 5090', provider: 'Vast.ai', price: 0.27, vram: 32, type: 'Mid-Range', providerType: 'Marketplace', gpuCount: 1, systemSpecs: { vCPU: 10, ram: 63 }, availability: 'Available', launchUrl: 'https://cloud.vast.ai/?ref_id=258548', slug: 'rtx5090', lastUpdated: new Date() },
  ...
  { id: 'runpod-rtx4090-1', model: 'NVIDIA RTX 4090', provider: 'RunPod', price: 0.34, vram: 24, type: 'Mid-Range', providerType: 'Cloud', gpuCount: 1, systemSpecs: { vCPU: 8, ram: 32 }, signupCredit: 'Up to $5', availability: 'Available', launchUrl: 'https://runpod.io/?ref=ywe09aak', slug: 'rtx4090', lastUpdated: new Date() },
