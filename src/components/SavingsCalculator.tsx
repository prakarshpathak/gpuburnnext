                    ...
                    {recommendation && (
                        <div className="flex flex-col justify-center space-y-4 md:space-y-6">
                            <div className="grid grid-cols-2 gap-3 md:gap-4">
                                <div className="p-3 md:p-4 rounded-xl bg-muted/50 border border-border">
                                    ...
                                    <div className="text-xl md:text-2xl font-mono font-bold text-muted-foreground line-through decoration-red-500/50">
                                        {formatCurrency(recommendation.avgOtherPrice)}<span className="text-xs md:text-sm font-sans">/hr</span>
                                    </div>
                                </div>
                                <div className="p-3 md:p-4 rounded-xl bg-green-50 dark:bg-green-900/10 border border-green-200 dark:border-green-900/30">
                                    <div className="text-xs md:text-sm text-green-600 dark:text-green-400 mb-1">Spheron Price</div>
                                    <div className="text-xl md:text-2xl font-mono font-bold text-green-600 dark:text-green-400">
                                        {formatCurrency(recommendation.spheronPrice)}<span className="text-xs md:text-sm text-green-600/70 font-sans">/hr</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            {!recommendation.hasSpheron && (
                                <div className="flex items-center gap-2 text-xs text-amber-600 dark:text-amber-400 bg-amber-50 dark:bg-amber-900/10 p-3 rounded-lg border border-amber-200 dark:border-amber-900/30">
